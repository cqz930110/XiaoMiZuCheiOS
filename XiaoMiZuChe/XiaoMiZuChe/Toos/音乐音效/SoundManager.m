...
- (void)hackDelay
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:@"msg_prompt" ofType:@"caf"]];
...
- (void)musicPlay
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:musicName ofType:@"caf"]];
...
- (void)musicPlayByName:(NSString *)name
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:name ofType:@"caf"]];
...
- (void)musicPlayFirst:(NSString *)firstName thenLoop:(NSString *)loopName
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:firstName ofType:@"caf"]];
...
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player successfully:(BOOL)flag
{
    ...
    NSURL *url = [NSURL fileURLWithPath:[[NSBundle mainBundle] pathForResource:musicNextLoopName ofType:@"caf"]];
