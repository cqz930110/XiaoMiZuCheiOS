...
@implementation ZCTabBarControllerConfig
...
- (NSArray *)viewControllers {
    ...
    MallViewController *thirdViewController = [[MallViewController alloc] init];
...
- (NSArray *)tabBarItemsAttributesForController {
    NSDictionary *firstTabBarItemsAttributes = @{
                                                 ...
                                                 CYLTabBarItemSelectedImage : @"icon_menu_home_active",
                                                 };
    NSDictionary *secondTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"租车",
                                                  CYLTabBarItemImage : @"icon_menu_hireCar",
                                                  CYLTabBarItemSelectedImage : @"icon_menu_hireCar_active",
                                                  };
    NSDictionary *thirdTabBarItemsAttributes = @{
                                                 CYLTabBarItemTitle : @"商城",
                                                 CYLTabBarItemImage : @"icon_menu_shop",
                                                 CYLTabBarItemSelectedImage : @"icon_menu_shop_active",
                                                 };
    NSDictionary *fourthTabBarItemsAttributes = @{
                                                  CYLTabBarItemTitle : @"我的",
                                                  CYLTabBarItemImage : @"icon_menu_my",
                                                  CYLTabBarItemSelectedImage : @"icon_menu_my_active"
                                                  };
...
- (void)customizeTabBarAppearance:(CYLTabBarController *)tabBarController {
    ...
    selectedAttrs[NSForegroundColorAttributeName] = [UIColor colorWithHexString:@"#F8B62A"];
